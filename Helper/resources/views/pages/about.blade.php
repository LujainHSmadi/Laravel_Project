      ...
      <section class="section section-lg bg-gray-1 bg-gray-1-decor">
        <div class="container">
          <div class="row row-50">
            <div class="col-lg-6 pr-xl-5"><img  style="margin-top: 115px" src="images/about-us-1(2)-518x430.jpg" alt="" width="518" height="430"/>
            </div>
            <div class="col-lg-6">
              <h3>About Helper</h3>
              <div class="text-with-divider">
                <div class="divider"></div>
                <h4 class="text-opacity-70">We are committed to helping families find their houses as they wish.</h4>
              </div>
              <p>
                Helper is a nonprofit dedicated to finding outstanding giving opportunities and publishing the full details of our analysis to help donors decide what to give . </p>
              <p>We spend thousands of hours each year reviewing academic evidence and researching different programs to identify the most cost-effective, evidence-backed ones.

                We focus on finding and recommending a small number of outstanding giving opportunities to help donors save or improve lives the most with their gifts. , along with all of the research supporting our funding recommendations. We hope that any donor can have access to high-quality information to inform their impact-based giving.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                ...
                <div class="box-icon-caption">
                  ...
                  <p>We are here to achieve changes in the world and make a mark won't be forgotten . </p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                ...
                <div class="box-icon-caption">
                  ...
                  <p>we are here to increase the awareness about the needed family and to not forget them</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="box-icon-modern">
                ...
                <div class="box-icon-caption">
                  ...
                  <p>One of the best aim is to spread happiness into the whole families and share it toghether</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row no-gutters">
            <div class="col-md-6 col-lg-4">
              <div class="team-classic">
                ...
                <div class="team-classic-caption">
                  <h4><a class="team-name" href="#">Lujain AlSmadi</a></h4>
                  <p>Web Developer</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="team-classic">
                ...
                <div class="team-classic-caption">
                  <h4><a class="team-name" href="#">Majd Safira</a></h4>
                  <p>Web Developer</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="team-classic">
                ...
                <div class="team-classic-caption">
                  <h4><a class="team-name" href="#">Haya Abdallah</a></h4>
                  <p>Web Developer</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="team-classic">
                ...
                <div class="team-classic-caption">
                  <h4><a class="team-name" href="#">Salam Almomani</a></h4>
                  <p>Web Developer</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="team-classic">
                ...
                <div class="team-classic-caption">
                  <h4><a class="team-name" href="#">Nada Alawneh</a></h4>
                  <p>Web Developer</p>
                </div>
              </div>
            </div>
